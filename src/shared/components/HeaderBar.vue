<template>
  <header class="sticky top-0 z-50 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 transition-colors duration-200">
      ...
      <div class="flex items-center justify-between h-16">
        ...
        <div class="flex items-center space-x-4">
          ...
          <button
            @click="toggleTheme"
            :aria-pressed="isDark"
            class="p-2 rounded-lg bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
...
const updateTime = () => {
  const now = new Date()
  currentTime.value = new Intl.DateTimeFormat(navigator.language, {
    hour: '2-digit',
    minute: '2-digit',
    day: '2-digit',
    month: 'short',
...
onMounted(() => {
  initTheme()
  updateTime()
  timeInterval = setInterval(updateTime, 30000) // Update every 30 seconds
})
